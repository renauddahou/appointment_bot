...
bot = telebot.TeleBot("1935902695:AAFMQQ9Mp7hEsgt-urO-6B29sokLc9yrSuA")  # Insert your bot's TOKEN here
driver = webdriver.Chrome("https://github.com/renauddahou/appointment_bot/blob/master/chromedriver/chromedriver.exe")  # Address browser driver (smth.exe)
